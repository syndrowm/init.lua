...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/evan/.local/share/nvim/site/pack/packer/start/copilot.vim",
    url = "https://github.com/github/copilot.vim"
  },
  ["dracula.nvim"] = {
    config = { "\27LJ\2\n7\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0\24colorscheme dracula\bcmd\bvim\0" },
    loaded = true,
    path = "/Users/evan/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  ["vim-buftabline"] = {
    loaded = true,
    path = "/Users/evan/.local/share/nvim/site/pack/packer/start/vim-buftabline",
  ...
  ["zen-mode.nvim"] = {
    loaded = true,
    path = "/Users/evan/.local/share/nvim/site/pack/packer/start/zen-mode.nvim",
